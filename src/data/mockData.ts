    ...
    disasterHistory: [
      {
        ...
        severity: "High",
        description:
          "Severe flooding affected residential areas and road connectivity.",
      },
      {
        id: "D002",
        type: "Landslide",
        ...
        severity: "Severe",
        description:
          "Slope failure disrupted access routes and damaged properties.",
      },
      {
        id: "D003",
        type: "Flood",
        ...
        severity: "High",
        description:
          "Recurring flood event affected low-lying habitation areas.",
      },
    ],
  },
  {
    ...
    disasterHistory: [
      {
        ...
        severity: "Severe",
        description:
          "Progressive shoreline erosion affected houses and infrastructure.",
      },
      {
        id: "D005",
        type: "Flood",
        ...
        severity: "High",
        description:
          "Coastal flooding affected access roads and agricultural land.",
      },
    ],
  },
  {
    ...
    disasterHistory: [
      {
        ...
        year: 2023,
        severity: "High",
        description: "Slope instability blocked the primary access road.",
      },
      {
        id: "D007",
        type: "Cloudburst",
        year: 2025,
        severity: "High",
        description: "Intense rainfall triggered debris movement.",
      },
    ],
  },
  {
    id: "H004",
    name: "River Side Colony",
    ...
    disasterHistory: [
      {
        ...
        severity: "Moderate",
        description:
          "River overflow temporarily inundated low-lying homes.",
      },
    ],
  },
  {
    ...
    disasterHistory: [
      {
        ...
        severity: "Moderate",
        description:
          "Short-duration intense rainfall caused minor drainage issues.",
      },
    ],
  },
];
...
export const redZoneData = {
  ...
  features: [
    {
      type: "Feature",
      properties: { id: "Z001", name: "High Risk Zone A", riskScore: 92 },
      geometry: {
        type: "Polygon",
        coordinates: [
          [
    ...
    {
      type: "Feature",
      properties: { id: "Z002", name: "High Risk Zone B", riskScore: 86 },
      geometry: {
        type: "Polygon",
        coordinates: [
          [
...
export const getPriorityColor = (priority: RelocationPriority) =>
  ({
    Immediate: "#dc2626",
    "Short-term": "#f97316",
    "Medium-term": "#2563eb",
